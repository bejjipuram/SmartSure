...
export const COUNTRY_LOCALES: CountryLocale[] = [
  ...
  { country: 'Germany',        flag: '🇩🇪', currencyCode: 'EUR', currencySymbol: '€',   timezone: 'Europe/Berlin',    locale: 'de-DE' },
  ...
  { country: 'Japan',          flag: '🇯🇵', currencyCode: 'JPY', currencySymbol: '¥',   timezone: 'Asia/Tokyo',       locale: 'ja-JP' },
  { country: 'Singapore',      flag: '🇸🇬', currencyCode: 'SGD', currencySymbol: 'S$',  timezone: 'Asia/Singapore',   locale: 'en-SG' },
  { country: 'UAE',            flag: '🇦🇪', currencyCode: 'AED', currencySymbol: 'د.إ', timezone: 'Asia/Dubai',       locale: 'ar-AE' },
];
...
export class LocaleService {
  ...
  private getCachedRates(): Record<string, number> | null {
    try {
      ...
      const required = ['USD', 'GBP', 'EUR', 'AUD', 'CAD', 'JPY', 'SGD', 'AED'];
