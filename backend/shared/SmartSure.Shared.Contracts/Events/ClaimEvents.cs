...
public record ClaimSubmittedEvent(int ClaimId, Guid PolicyId, Guid UserId, string PolicyNumber, string ClaimNumber, decimal ClaimAmount, DateTime IncidentDate, string Description, string OldStatus, string NewStatus, string CustomerName = "");
